...
class Tindakanberobat extends CI_Controller
{
  ...
  function cetakantrian($id){
        ...
        $pdf->Cell(10,5,'',0,0,'C');
        $pdf->setFont('Arial','',7);
        $pdf->Cell(90,5,'- Kartu ini hanya bisa digunakan untuk berobat di Puskesmas.',0,1,'L');
   ...
   function rujukan_action(){
    ...
    $sql_rekamedis    = "SELECT tr.*,pd.no_rawat,pd.tanggal_daftar 
        ...
        //$pdf->Image('', a)
        // mencetak string 
        $pdf->Cell(268, 7, 'PUSKESMAS ', 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(268, 7, '          INDONESIA.', 0, 1, 'C');
        $pdf->Cell(268, 7, 'Telepon : (0264) 1111111. E-mail: puskesmas@gmail.com', 0, 1, 'C');
