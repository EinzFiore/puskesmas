<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('pegawai/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-microsoft btn-sm"'); ?>
		<?php echo anchor(site_url('pegawai/cetak'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Cetak Data Pegawai', 'class="btn btn-soundcloud btn-sm"'); ?></div>
