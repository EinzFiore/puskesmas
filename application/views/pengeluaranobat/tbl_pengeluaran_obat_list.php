<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('pengeluaranobat/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-microsoft btn-sm"'); ?>
		<?php echo anchor(site_url('pengeluaranobat/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-soundcloud btn-sm"'); ?></div>
