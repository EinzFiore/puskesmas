<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('pendaftaran/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-microsoft btn-sm"'); ?>
        <?php echo anchor(site_url('pendaftaran/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-soundcloud btn-sm"'); ?>
        <?php echo anchor(site_url('pendaftaran/cetakbulan'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data Bulan Ini', 'class="btn btn-vk btn-sm"'); ?>
        </div>
            </div>
            <div class='col-md-3'>
        ...
        <th>Action</th>
            ...
            <td style="text-align:center" width="200px">
                <?php 
                echo anchor(site_url('pendaftaran/cetakantrian/'.$pendaftaran->no_rawat),'<i class="fa fa-print" aria-hidden="true"></i>','class="btn btn-facebook btn-sm"'); 
                echo '  ';
                ?>
                <?php 
