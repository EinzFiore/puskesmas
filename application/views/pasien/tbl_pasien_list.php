<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('pasien/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-microsoft btn-sm"'); ?>
         <?php echo anchor(site_url('pasien/cetak'), '<i class="fa fa-print" aria-hidden="true"></i> Cetak Data', 'class="btn btn-soundcloud btn-sm"'); ?>
        </div>
            </div>
            <div class='col-md-3'>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('pasien/update/'.$pasien->no_rekamedis),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>','class="btn btn-success btn-sm"'); 
				echo '  '; 
                echo anchor(site_url('pasien/cetakkartu/').$pasien->no_rekamedis,'<i class="fa fa-print" aria-hidden="true"></i>','class="btn btn-facebook btn-sm"'); 
                echo '  '; 
