...
<table class='table table-bordered>'        
		...
		<tr><td width='200'>No Trans <?php echo form_error('no_trans') ?></td><td><input type="text" class="form-control" name="no_trans" id="no_trans" placeholder="Nomor Transaksi" value="<?php echo "B-".date("ymd")."-".noPengadaAuto();?>" readonly  /></td></tr>
	    ...
	    <tr><td></td><td><input type="hidden" name="id_pengadaan" value="<?php echo noPengadaAuto() ; ?>" /> 

	    <button type="submit" class="btn btn-success"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('pengadaanobat') ?>" class="btn btn-danger"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>
