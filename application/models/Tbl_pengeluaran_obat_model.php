...
class Tbl_pengeluaran_obat_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('pengeluaranobat/cetaklabel/$1'),'<i class="fa fa-print" aria-hidden="true"></i>', array('class' => 'btn btn-facebook btn-sm'))." 
